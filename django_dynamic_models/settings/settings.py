# Django settings for django_dynamic_models project.
import os
import sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(DJANGO_PROJECT_ROOT),'db.sqlite3'),# Or path to database file if using sqlite3.
...
SECRET_KEY = '0wo(&9-#rdu*$xh0qdc)_!_t#baf#k^eoh)j-fufh$-2(64bk#'
